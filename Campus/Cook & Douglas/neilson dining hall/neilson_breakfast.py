...
def get_cd_breakfast_items():

    # Make the request to the webpage
    bpage_scrape = requests.get("https://menuportal23.dining.rutgers.edu/FoodPro/pickmenu.asp?locationNum=05&locationName=Neilson+Dining+Hall&dtdate=3/26/2024&mealName=Breakfast&sName=Rutgers+University+Dining")
