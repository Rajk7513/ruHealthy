...
def get_cd_lunch_items():
    bpage_scrape = requests.get("https://menuportal23.dining.rutgers.edu/FoodPro/pickmenu.asp?locationNum=05&locationName=Neilson+Dining+Hall&dtdate=3/26/2024&mealName=Lunch&sName=Rutgers+University+Dining")
