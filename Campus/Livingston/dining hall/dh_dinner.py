...
bpage_scrape = requests.get("https://menuportal23.dining.rutgers.edu/FoodPro/pickmenu.asp?locationNum=03&locationName=Livingston+Dining+Commons&dtdate=3/25/2024&mealName=Dinner&sName=Rutgers+University+Dining")
...
if bpage_scrape.status_code == 200:
    ...
    # Print the list of dinner items
