...
def get_livi_breakfast_items():
    # Make the request to the webpage
    bpage_scrape = requests.get("https://menuportal23.dining.rutgers.edu/FoodPro/pickmenu.asp?locationNum=03&locationName=Livingston+Dining+Commons&dtdate=3/25/2024&mealName=Breakfast&sName=Rutgers+University+Dining")
